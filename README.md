...
(The workflow of the st-pipeline is the following: Quality filter, ncRNA filter, Aligning, De-multiplexing, Annotation)
```
sample=10t
...
In order to mitigate the technical differences in gene expression between or in-between samples
